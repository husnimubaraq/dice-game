    ...
    return (
        <>
            <HTMLFlipBook
                ...
                className="demo-book"
            >
                <div className="bg-[#f2b480] p-5 flex flex-col rounded-3xl">
                ...
                <div className="bg-[#f2b480] p-5 flex flex-col rounded-3xl">
                    ...
                    />
                    <p className="indent-8 leading-8">Serbuan pasukan Pangeran Diponegoro mengejutkan tentara Hindia Belanda dan membuat panik para pembesar keraton dan pemerintah Belanda. Residen Smissaert segera melaporkan kepada Jenderal de Kock karena kekuatan yang sangat tidak seimbang. Kemudian Jenderal de Kock ditugaskan sebagai Komisaris Pemerintah untuk Keraton Yogyakarta dan kekuasaan penuh untuk menumpas pemberontakan Pangeran Diponegoro. Jenderal de Kock mengumpulkan semua pasukannya yang berada di berbagai wilayah di Nusantara untuk berkumpul di Jawa. </p>

                </div>
                <div className="bg-[#f2b480] p-5 flex flex-col rounded-3xl">
                    <p className="indent-8 leading-8">Selanjutnya Jenderal de Kock merencanakan operasi besar-besaran untuk merebut kembali Yogyakarta dan menghancurkan markas besar Pangeran Diponegoro di Selarong, dengan persiapan yang matang dan cermat. Jenderal De Kock mengirimkan surat kepada Pangeran Diponegoro di Selarong, dan kemudian pihak Pangeran Diponegoro pun mengirimkan balasan.</p>
                    ...
                    <p className="indent-8 leading-8">Hingga penangkapan Pangeran Diponegoro terjadi pada 28 Maret 1830, dan merupakan titik penting dalam sejarah perjuangan melawan kolonialisme Belanda. </p>

                </div>
                <div className="bg-[#f2b480] p-5 flex flex-col rounded-3xl">
                    <p className="indent-8 leading-8">Setelah berjuang selama lima tahun dalam Perang Jawa (1825-1830), Pangeran Diponegoro setuju untuk menghadiri perundingan di Magelang. Diponegoro dan pengikutnya tiba dengan niat baik, berharap adanya jalan damai. Namun, Jenderal De Kock memanfaatkan situasi ini untuk menahan Pangeran Diponegoro. Penangkapan tersebut dilakukan tanpa pertempuran langsung, dan Pangeran Diponegoro segera diasingkan ke Manado, Pangeran Diponegoro menghabiskan sisa hidupnya di Makassar.</p>
                    <p className="text-lg font-bold mt-5 mb-2">Pengasingan Pangeran Diponegoro</p>
                    <p className="indent-8 leading-8">Setelah penangkapan pada 28 Maret 1830, Pangeran Diponegoro diasingkan oleh Belanda. Pada awalnya, ia dibawa ke Ungaran, lalu dipindahkan ke Batavia (sekarang Jakarta). Setelah itu, Diponegoro diasingkan ke Manado pada tahun 1830, di Benteng Amsterdam. </p>

                </div>
                <div className="bg-[#f2b480] p-5 flex flex-col rounded-3xl">
                    <p className="indent-8 leading-8">Namun, karena dianggap terlalu berpengaruh di sana, ia kemudian dipindahkan ke Makassar pada tahun 1834.</p>
                    <p className="indent-8 leading-8">Di Makassar, Diponegoro tinggal di Benteng Rotterdam dan menjalani sisa hidupnya dalam pengasingan hingga wafat pada 8 Januari 1855. Pengasingan ini mengakhiri perlawanan besar melawan Belanda. Pengasingan Pangeran Diponegoro merupakan akhir dari perjuangannya melawan kolonial Belanda setelah penangkapannya pada tahun 1830. Setelah ditangkap Pangeran Diponegoro awalnya dibawa ke Batavia sebelum diasingkan ke Manado, Sulawesi Utara, di Benteng Amsterdam. Namun, karena pengaruhnya yang masih kuat di kalangan masyarakat ia kemudian dipindahkan ke Makassar pada tahun 1834. Di Makassar, Pangeran Diponegoro ditahan di Benteng Rotterdam dan Belanda terus mengawasi Pangeran Diponegoro dengan ketat karena khawatir akan pengaruh Pangeran Diponegoro </p>

                </div>
                <div className="bg-[#f2b480] p-5 flex flex-col rounded-3xl">
                    <p className="indent-8 leading-8">yang masih kuat terhadap masyarakat Jawa. Pangeran Diponegoro menjalani sisa hidupnya di Makassar hingga wafat pada 8 Januari 1855. Meskipun hidup dalam pengasingan, semangat perjuangannya tetap menginspirasi generasi berikutnya dalam melawan Belanda (Hanifatul, 2019).</p>
                ...
                <div className="bg-[#f2b480] p-5 flex flex-col rounded-3xl">
                    ...
                    <p className="whitespace-pre-wrap">Dewi, V. M., Hartanto, W., & Puji, R. P. N. (2020). Pangeran Diponegoro Dalam Perang Jawa 1825-1830. Sindang: Jurnal Pendidikan Sejarah Dan Kajian Sejarah, 2(2), 2020. https://doi.org/https://doi.org/10.31540/sindang.v2i2.254</p>
